...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipantRoles'
        db.create_table(u'schedule_participantroles', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('schedule', ['ParticipantRoles'])

        # Deleting field 'EventParticipants.role'
        db.delete_column(u'schedule_eventparticipants', 'role')

        # Adding M2M table for field role on 'EventParticipants'
        m2m_table_name = db.shorten_name(u'schedule_eventparticipants_role')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventparticipants', models.ForeignKey(orm['schedule.eventparticipants'], null=False)),
            ('participantroles', models.ForeignKey(orm['schedule.participantroles'], null=False))
        ))
        db.create_unique(m2m_table_name, ['eventparticipants_id', 'participantroles_id'])


    def backwards(self, orm):
        # Deleting model 'ParticipantRoles'
        db.delete_table(u'schedule_participantroles')

        # Adding field 'EventParticipants.role'
        db.add_column(u'schedule_eventparticipants', 'role',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field role on 'EventParticipants'
        db.delete_table(db.shorten_name(u'schedule_eventparticipants_role'))
