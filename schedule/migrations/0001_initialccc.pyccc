...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'schedule_event', (
            ...
            ('category', self.gf('django.db.models.fields.IntegerField')(default=None)),
            ...
            ('venuecity', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('venuecountry', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.create_table(u'schedule_eventfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('schedule', ['EventFile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'schedule_eventfile')
