...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventParticipants.funding'
        db.alter_column(u'schedule_eventparticipants', 'funding', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EventParticipants.role'
        db.alter_column(u'schedule_eventparticipants', 'role', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EventParticipants.representing_region'
        db.alter_column(u'schedule_eventparticipants', 'representing_region', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'EventParticipants.funding'
        db.alter_column(u'schedule_eventparticipants', 'funding', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'EventParticipants.role'
        db.alter_column(u'schedule_eventparticipants', 'role', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'EventParticipants.representing_region'
        db.alter_column(u'schedule_eventparticipants', 'representing_region', self.gf('django.db.models.fields.IntegerField')(default=''))
