...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'schedule_event', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='event_country_page', to=orm['ippc.CountryPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.country'
        db.delete_column(u'schedule_event', 'country_id')
    ...
    models = {
        ...
        'schedule.event': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_country_page'", 'to': u"orm['ippc.CountryPage']"}),
