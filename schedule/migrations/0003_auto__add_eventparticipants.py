...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventParticipants'
        db.create_table(u'schedule_eventparticipants', (
            ...
            ('registered', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('registered_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('funding', self.gf('django.db.models.fields.IntegerField')(default=None)),
            ('representing_country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CountryPage'], null=True, blank=True)),
            ('representing_organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.PartnersPage'], null=True, blank=True)),
            ('representing_region', self.gf('django.db.models.fields.IntegerField')(default=None)),
        ))
        db.send_create_signal('schedule', ['EventParticipants'])


    def backwards(self, orm):
        # Deleting model 'EventParticipants'
        db.delete_table(u'schedule_eventparticipants')
    ...
    models = {
        ...
        'schedule.eventparticipants': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Event']"}),
            'funding': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'representing_region': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
