...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field topic_numbers on 'Event'
        m2m_table_name = db.shorten_name(u'schedule_event_topic_numbers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['schedule.event'], null=False)),
            ('topic', models.ForeignKey(orm[u'ippc.topic'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'topic_id'])


    def backwards(self, orm):
        # Removing M2M table for field topic_numbers on 'Event'
        db.delete_table(db.shorten_name(u'schedule_event_topic_numbers'))
    ...
    models = {
        ...
        u'ippc.draftingbodytype': {
            'Meta': {'object_name': 'DraftingBodyType'},
            'draftingbody': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'ippc.issuekeyword': {
        ...
        u'ippc.stratigicobjective': {
            'Meta': {'object_name': 'StratigicObjective'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'strategicobj': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        },
        u'ippc.topic': {
            'Meta': {'object_name': 'Topic'},
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'addedtolist': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'assistant_lead': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assistant_lead'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'assistant_steward': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assistant_steward'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'discipline_lead': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'discipline_lead'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'drafting_body': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'drafting_body+'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['ippc.DraftingBodyType']"}),
            ...
            'lead_steward': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lead_steward'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'priority': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'referee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'referee'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'specification_number': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'strategicobj': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['ippc.StratigicObjective']", 'null': 'True', 'blank': 'True'}),
            'summary': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'topic_under': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'topicnumber': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'topicstatus': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'treatment_lead': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'treatment_lead'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'pages.page': {
        ...
        'schedule.event': {
            ...
            'topic_numbers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'ev_topic_numbers'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['ippc.Topic']"}),
        ...
        'schedule.eventparticipants': {
            ...
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'role+'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['schedule.ParticipantRoles']"}),
        ...
        'schedule.participantroles': {
            'Meta': {'object_name': 'ParticipantRoles'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
