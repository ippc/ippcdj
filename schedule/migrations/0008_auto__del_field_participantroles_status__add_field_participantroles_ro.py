...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParticipantRoles.status'
        db.delete_column(u'schedule_participantroles', 'status')

        # Adding field 'ParticipantRoles.role'
        db.add_column(u'schedule_participantroles', 'role',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ParticipantRoles.status'
        db.add_column(u'schedule_participantroles', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Deleting field 'ParticipantRoles.role'
        db.delete_column(u'schedule_participantroles', 'role')
