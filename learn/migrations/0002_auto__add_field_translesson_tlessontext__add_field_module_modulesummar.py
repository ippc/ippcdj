...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransLesson.tlessontext'
        db.add_column(u'learn_translesson', 'tlessontext',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'Module.modulesummary'
        db.add_column(u'learn_module', 'modulesummary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransLesson.tlessontext'
        db.delete_column(u'learn_translesson', 'tlessontext')

        # Deleting field 'Module.modulesummary'
        db.delete_column(u'learn_module', 'modulesummary')
