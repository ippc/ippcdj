...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionField.text'
        db.alter_column(u'learn_questionfield', 'text', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'QuestionField.text'
        db.alter_column(u'learn_questionfield', 'text', self.gf('django.db.models.fields.CharField')(max_length=255))
