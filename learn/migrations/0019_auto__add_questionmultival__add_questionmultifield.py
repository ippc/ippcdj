...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionMultiVal'
        db.create_table(u'learn_questionmultival', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learn.QuestionMultiField'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'learn', ['QuestionMultiVal'])

        # Adding model 'QuestionMultiField'
        db.create_table(u'learn_questionmultifield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'learn', ['QuestionMultiField'])


    def backwards(self, orm):
        # Deleting model 'QuestionMultiVal'
        db.delete_table(u'learn_questionmultival')

        # Deleting model 'QuestionMultiField'
        db.delete_table(u'learn_questionmultifield')
