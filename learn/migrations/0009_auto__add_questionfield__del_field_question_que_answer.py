...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionField'
        db.create_table(u'learn_questionfield', (
        ...
        db.send_create_signal(u'learn', ['QuestionField'])

        # Deleting field 'Question.que_answer'
        db.delete_column(u'learn_question', 'que_answer')


    def backwards(self, orm):
        # Deleting model 'QuestionField'
        db.delete_table(u'learn_questionfield')

        # Adding field 'Question.que_answer'
        db.add_column(u'learn_question', 'que_answer',
    ...
    models = {
        ...
        u'learn.question': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'userquestion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'question_author'", 'to': u"orm['auth.User']"})
        },
