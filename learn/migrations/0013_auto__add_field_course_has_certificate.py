...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.has_certificate'
        db.add_column(u'learn_course', 'has_certificate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.has_certificate'
        db.delete_column(u'learn_course', 'has_certificate')
