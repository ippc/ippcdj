...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'learn_questionresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learn.Question'])),
            ('userquestion', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_user', to=orm['auth.User'])),
            ('result', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
        ))
        db.send_create_signal(u'learn', ['QuestionResult'])

        # Deleting field 'Question.userquestion'
        db.delete_column(u'learn_question', 'userquestion_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'learn_questionresult')

        # Adding field 'Question.userquestion'
        db.add_column(u'learn_question', 'userquestion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1625, related_name='question_author', to=orm['auth.User']),
                      keep_default=False)
