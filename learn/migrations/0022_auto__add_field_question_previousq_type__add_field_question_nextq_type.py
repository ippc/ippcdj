...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.previousq_type'
        db.add_column(u'learn_question', 'previousq_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Question.nextq_type'
        db.add_column(u'learn_question', 'nextq_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'QuestionM.previousq_type'
        db.add_column(u'learn_questionm', 'previousq_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'QuestionM.nextq_type'
        db.add_column(u'learn_questionm', 'nextq_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.previousq_type'
        db.delete_column(u'learn_question', 'previousq_type')

        # Deleting field 'Question.nextq_type'
        db.delete_column(u'learn_question', 'nextq_type')

        # Deleting field 'QuestionM.previousq_type'
        db.delete_column(u'learn_questionm', 'previousq_type')

        # Deleting field 'QuestionM.nextq_type'
        db.delete_column(u'learn_questionm', 'nextq_type')
