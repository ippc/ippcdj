...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.previousq'
        db.add_column(u'learn_question', 'previousq',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.nextq'
        db.add_column(u'learn_question', 'nextq',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.previousq'
        db.delete_column(u'learn_question', 'previousq')

        # Deleting field 'Question.nextq'
        db.delete_column(u'learn_question', 'nextq')
