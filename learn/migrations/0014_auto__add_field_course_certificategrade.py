...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.certificategrade'
        db.add_column(u'learn_course', 'certificategrade',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.certificategrade'
        db.delete_column(u'learn_course', 'certificategrade')
