...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionM'
        db.create_table(u'learn_questionm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('q_summary', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('quiz', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quizm', to=orm['learn.Quiz'])),
            ('q_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('previousq', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('nextq', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'learn', ['QuestionM'])


        # Changing field 'QuestionMultiField.question'
        db.alter_column(u'learn_questionmultifield', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learn.QuestionM']))

    def backwards(self, orm):
        # Deleting model 'QuestionM'
        db.delete_table(u'learn_questionm')


        # Changing field 'QuestionMultiField.question'
        db.alter_column(u'learn_questionmultifield', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learn.Question']))
