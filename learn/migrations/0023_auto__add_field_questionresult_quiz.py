...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionResult.quiz'
        db.add_column(u'learn_questionresult', 'quiz',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['learn.Quiz']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionResult.quiz'
        db.delete_column(u'learn_questionresult', 'quiz_id')
