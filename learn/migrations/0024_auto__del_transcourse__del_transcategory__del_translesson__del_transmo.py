...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'eLearnAutoRegistration'
        db.create_table(u'learn_elearnautoregistration', (
            ...
            ('organisation', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('summary', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'learn', ['eLearnAutoRegistration'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'learn_translesson', (
            ...
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('tlessontext', self.gf('django.db.models.fields.TextField')(max_length=1000, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ...
        # Deleting model 'eLearnAutoRegistration'
        db.delete_table(u'learn_elearnautoregistration')
    ...
    models = {
        ...
        u'learn.elearnautoregistration': {
            'Meta': {'object_name': 'eLearnAutoRegistration'},
            ...
            'summary': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        },
        u'learn.lesson': {
        ...
        u'learn.question': {
            ...
            'nextq_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'previousq': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'previousq_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        u'learn.questionresult': {
            ...
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['learn.Question']"}),
            'quiz': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['learn.Quiz']"}),
