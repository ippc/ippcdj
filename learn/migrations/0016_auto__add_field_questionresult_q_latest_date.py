...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionResult.q_latest_date'
        db.add_column(u'learn_questionresult', 'q_latest_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionResult.q_latest_date'
        db.delete_column(u'learn_questionresult', 'q_latest_date')
