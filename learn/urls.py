...
from .views import CourseListView,CourseDetailView,ModuleListView,ModuleDetailView,LessonDetailView,QuizDetailView,question_answer,course_enroll,course_certificate,CertPDFView,eLearnAutoRegistrationListView,auto_register_elearn,auto_register_elearn_approve,auto_register_elearn_delete,requestaccess
