...
from .ippc.views import PestReportListView, PestReportDetailView, CountryView, pest_report_create, pest_report_edit
...
urlpatterns = patterns("",
    ...
    # pest report edit
    url(r'^countries/(?P<country>[\w-]+)/pestreports/edit/$',
