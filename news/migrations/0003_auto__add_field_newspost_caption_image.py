...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsPost.caption_image'
        db.add_column(u'news_newspost', 'caption_image',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsPost.caption_image'
        db.delete_column(u'news_newspost', 'caption_image')
