...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransNewsPost.caption_image'
        db.add_column(u'news_transnewspost', 'caption_image',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransNewsPost.caption_image'
        db.delete_column(u'news_transnewspost', 'caption_image')
    ...
    models = {
        ...
        u'comments.comment': {
            ...
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '10'}),
        ...
        u'news.newspost': {
            ...
            'caption_image': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
        ...
        u'news.transnewspost': {
            'Meta': {'ordering': "('lang',)", 'object_name': 'TransNewsPost'},
            'caption_image': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'translation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translation'", 'to': u"orm['news.NewsPost']"})
        },
        u'sites.site': {
