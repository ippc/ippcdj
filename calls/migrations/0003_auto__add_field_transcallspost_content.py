...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransCallsPost.content'
        db.add_column(u'calls_transcallspost', 'content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransCallsPost.content'
        db.delete_column(u'calls_transcallspost', 'content')
