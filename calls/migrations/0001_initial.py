...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CallsPost'
        db.create_table(u'calls_callspost', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='callsposts', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'calls', ['CallsPost'])

        # Adding M2M table for field categories on 'CallsPost'
        m2m_table_name = db.shorten_name(u'calls_callspost_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('callspost', models.ForeignKey(orm[u'calls.callspost'], null=False)),
            ('callscategory', models.ForeignKey(orm[u'calls.callscategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['callspost_id', 'callscategory_id'])

        # Adding M2M table for field related_posts on 'CallsPost'
        m2m_table_name = db.shorten_name(u'calls_callspost_related_posts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_callspost', models.ForeignKey(orm[u'calls.callspost'], null=False)),
            ('to_callspost', models.ForeignKey(orm[u'calls.callspost'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_callspost_id', 'to_callspost_id'])

        # Adding model 'CallsCategory'
        db.create_table(u'calls_callscategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'calls', ['CallsCategory'])


    def backwards(self, orm):
        # Deleting model 'CallsPost'
        db.delete_table(u'calls_callspost')

        # Removing M2M table for field categories on 'CallsPost'
        db.delete_table(db.shorten_name(u'calls_callspost_categories'))

        # Removing M2M table for field related_posts on 'CallsPost'
        db.delete_table(db.shorten_name(u'calls_callspost_related_posts'))

        # Deleting model 'CallsCategory'
        db.delete_table(u'calls_callscategory')
    ...
    models = {
        ...
        u'calls.callscategory': {
            'Meta': {'ordering': "('title',)", 'object_name': 'CallsCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'calls.callspost': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'CallsPost'},
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'allow_comments': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'callsposts'", 'blank': 'True', 'to': u"orm['calls.CallsCategory']"}),
            ...
            'related_posts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_posts_rel_+'", 'blank': 'True', 'to': u"orm['calls.CallsPost']"}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'callsposts'", 'to': u"orm['auth.User']"})
        },
        u'comments.comment': {
