...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'File'
        db.delete_table(u'ippc_file')

        # Deleting field 'Publication.status'
        db.delete_column(u'ippc_publication', 'status')

        # Deleting field 'Publication.short_url'
        db.delete_column(u'ippc_publication', 'short_url')

        # Deleting field 'Publication.site'
        db.delete_column(u'ippc_publication', 'site_id')

        # Deleting field 'Publication.in_sitemap'
        db.delete_column(u'ippc_publication', 'in_sitemap')

        # Deleting field 'Publication.keywords_string'
        db.delete_column(u'ippc_publication', 'keywords_string')

        # Deleting field 'Publication._meta_title'
        db.delete_column(u'ippc_publication', '_meta_title')

        # Deleting field 'Publication.publish_date'
        db.delete_column(u'ippc_publication', 'publish_date')

        # Deleting field 'Publication.gen_description'
        db.delete_column(u'ippc_publication', 'gen_description')

        # Deleting field 'Publication.expiry_date'
        db.delete_column(u'ippc_publication', 'expiry_date')

        # Deleting field 'Publication.description'
        db.delete_column(u'ippc_publication', 'description')

        # Adding field 'Publication._order'
        db.add_column(u'ippc_publication', '_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Publication.file_en'
        db.add_column(u'ippc_publication', 'file_en',
                      self.gf('django.db.models.fields.files.FileField')(max_length=204, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.file_es'
        db.add_column(u'ippc_publication', 'file_es',
                      self.gf('django.db.models.fields.files.FileField')(max_length=204, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.file_fr'
        db.add_column(u'ippc_publication', 'file_fr',
                      self.gf('django.db.models.fields.files.FileField')(max_length=204, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.file_ru'
        db.add_column(u'ippc_publication', 'file_ru',
                      self.gf('django.db.models.fields.files.FileField')(max_length=204, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.file_ar'
        db.add_column(u'ippc_publication', 'file_ar',
                      self.gf('django.db.models.fields.files.FileField')(max_length=204, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.file_zh'
        db.add_column(u'ippc_publication', 'file_zh',
                      self.gf('django.db.models.fields.files.FileField')(max_length=204, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Publication.title'
        db.alter_column(u'ippc_publication', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Publication.slug'
        db.alter_column(u'ippc_publication', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200, null=True))
        # Adding index on 'Publication', fields ['slug']
        db.create_index(u'ippc_publication', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Publication', fields ['slug']
        db.delete_index(u'ippc_publication', ['slug'])

        # Adding model 'File'
        db.create_table(u'ippc_file', (
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('publication', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publications', to=orm['ippc.Publication'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=200, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=204)),
            ('last_change', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'ippc', ['File'])

        # Adding field 'Publication.status'
        db.add_column(u'ippc_publication', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Publication.short_url'
        db.add_column(u'ippc_publication', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.site'
        db.add_column(u'ippc_publication', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='127.0.0.1.8000', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Publication.in_sitemap'
        db.add_column(u'ippc_publication', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Publication.keywords_string'
        db.add_column(u'ippc_publication', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Publication._meta_title'
        db.add_column(u'ippc_publication', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.publish_date'
        db.add_column(u'ippc_publication', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.gen_description'
        db.add_column(u'ippc_publication', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Publication.expiry_date'
        db.add_column(u'ippc_publication', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.description'
        db.add_column(u'ippc_publication', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Publication._order'
        db.delete_column(u'ippc_publication', '_order')

        # Deleting field 'Publication.file_en'
        db.delete_column(u'ippc_publication', 'file_en')

        # Deleting field 'Publication.file_es'
        db.delete_column(u'ippc_publication', 'file_es')

        # Deleting field 'Publication.file_fr'
        db.delete_column(u'ippc_publication', 'file_fr')

        # Deleting field 'Publication.file_ru'
        db.delete_column(u'ippc_publication', 'file_ru')

        # Deleting field 'Publication.file_ar'
        db.delete_column(u'ippc_publication', 'file_ar')

        # Deleting field 'Publication.file_zh'
        db.delete_column(u'ippc_publication', 'file_zh')


        # Changing field 'Publication.title'
        db.alter_column(u'ippc_publication', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

        # Changing field 'Publication.slug'
        db.alter_column(u'ippc_publication', 'slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
    ...
    models = {
        ...
        u'ippc.publication': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publication_author'", 'to': u"orm['auth.User']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publication_libraries'", 'to': u"orm['ippc.PublicationLibrary']"}),
