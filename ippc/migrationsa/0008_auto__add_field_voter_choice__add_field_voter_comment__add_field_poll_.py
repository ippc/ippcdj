...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.choice'
        db.add_column(u'ippc_voter', 'choice',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Voter.comment'
        db.add_column(u'ippc_voter', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Poll.description'
        db.add_column(u'ippc_poll', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'Poll.close_date'
        db.add_column(u'ippc_poll', 'close_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.choice'
        db.delete_column(u'ippc_voter', 'choice')

        # Deleting field 'Voter.comment'
        db.delete_column(u'ippc_voter', 'comment')

        # Deleting field 'Poll.description'
        db.delete_column(u'ippc_poll', 'description')

        # Deleting field 'Poll.close_date'
        db.delete_column(u'ippc_poll', 'close_date')
