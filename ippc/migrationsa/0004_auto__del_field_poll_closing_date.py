...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Poll.closing_date'
        db.delete_column(u'ippc_poll', 'closing_date')


    def backwards(self, orm):
        # Adding field 'Poll.closing_date'
        db.add_column(u'ippc_poll', 'closing_date',
    ...
    models = {
        ...
        u'ippc.poll': {
            ...
            'polltext': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
