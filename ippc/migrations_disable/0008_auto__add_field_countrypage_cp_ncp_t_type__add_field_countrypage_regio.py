...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryPage.cp_ncp_t_type'
        db.add_column(u'ippc_countrypage', 'cp_ncp_t_type',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=3),
                      keep_default=False)

        # Adding field 'CountryPage.region'
        db.add_column(u'ippc_countrypage', 'region',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'CountryPage.cn_flag'
        db.add_column(u'ippc_countrypage', 'cn_flag',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CountryPage.image'
        db.add_column(u'ippc_countrypage', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountryPage.cp_ncp_t_type'
        db.delete_column(u'ippc_countrypage', 'cp_ncp_t_type')

        # Deleting field 'CountryPage.region'
        db.delete_column(u'ippc_countrypage', 'region')

        # Deleting field 'CountryPage.cn_flag'
        db.delete_column(u'ippc_countrypage', 'cn_flag')

        # Deleting field 'CountryPage.image'
        db.delete_column(u'ippc_countrypage', 'image')
