...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryPage.cn_map'
        db.add_column(u'ippc_countrypage', 'cn_map',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=550),
                      keep_default=False)


        # Changing field 'Publication.old_id'
        db.alter_column(u'ippc_publication', 'old_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'CountryPage.cn_map'
        db.delete_column(u'ippc_countrypage', 'cn_map')


        # Changing field 'Publication.old_id'
        db.alter_column(u'ippc_publication', 'old_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
