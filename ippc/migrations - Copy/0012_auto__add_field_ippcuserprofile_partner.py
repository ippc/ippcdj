...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IppcUserProfile.partner'
        db.add_column(u'ippc_ippcuserprofile', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_partner_page', null=True, to=orm['ippc.PartnersPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IppcUserProfile.partner'
        db.delete_column(u'ippc_ippcuserprofile', 'partner_id')
