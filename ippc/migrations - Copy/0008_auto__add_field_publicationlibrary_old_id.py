...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicationLibrary.old_id'
        db.add_column(u'ippc_publicationlibrary', 'old_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicationLibrary.old_id'
        db.delete_column(u'ippc_publicationlibrary', 'old_id')
