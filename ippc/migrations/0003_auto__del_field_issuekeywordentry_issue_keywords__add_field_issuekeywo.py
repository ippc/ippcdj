...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IssueKeywordEntry.issue_keywords'
        db.delete_column(u'ippc_issuekeywordentry', 'issue_keywords_id')
    ...
    def backwards(self, orm):
        # Adding field 'IssueKeywordEntry.issue_keywords'
        db.add_column(u'ippc_issuekeywordentry', 'issue_keywords',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeyword'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'ippc.issuekeywordentry': {
            'Meta': {'ordering': "['-key_issue']", 'object_name': 'IssueKeywordEntry'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
