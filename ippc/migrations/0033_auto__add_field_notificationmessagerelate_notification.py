...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ippc_notificationmessagerelate', 'notification',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.NotificationMessage'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field notification on 'NotificationMessageRelate'
        db.delete_table(db.shorten_name(u'ippc_notificationmessagerelate_notification'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field notification on 'NotificationMessageRelate'
        m2m_table_name = db.shorten_name(u'ippc_notificationmessagerelate_notification')
    ...
    models = {
        ...
        u'ippc.notificationmessagerelate': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notification': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.NotificationMessage']", 'null': 'True', 'blank': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'ippc.partnersnews': {
