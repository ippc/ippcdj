...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationMessageRelate.notify'
        db.add_column(u'ippc_notificationmessagerelate', 'notify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationMessageRelate.notify'
        db.delete_column(u'ippc_notificationmessagerelate', 'notify')
