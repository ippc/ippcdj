...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PestReport.pest_identity' to match new field type.
        db.rename_column(u'ippc_pestreport', 'pest_identity', 'pest_identity_id')
        ...
        # Adding index on 'PestReport', fields ['pest_identity']
        db.create_index(u'ippc_pestreport', ['pest_identity_id'])

        # Deleting field 'EventReporting.eppo'
        db.delete_column(u'ippc_eventreporting', 'eppo_id')


    def backwards(self, orm):
        # Removing index on 'PestReport', fields ['pest_identity']
        db.delete_index(u'ippc_pestreport', ['pest_identity_id'])


        # Renaming column for 'PestReport.pest_identity' to match new field type.
        db.rename_column(u'ippc_pestreport', 'pest_identity_id', 'pest_identity')
        # Changing field 'PestReport.pest_identity'
        db.alter_column(u'ippc_pestreport', 'pest_identity', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'EventReporting.eppo'
        db.add_column(u'ippc_eventreporting', 'eppo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.EppoCodes'], null=True, blank=True),
                      keep_default=False)
