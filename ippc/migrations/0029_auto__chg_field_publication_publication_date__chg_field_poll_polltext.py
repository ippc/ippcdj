...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ippc_publication', 'publication_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Poll.polltext'
        db.alter_column(u'ippc_poll', 'polltext', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Publication.publication_date'
        db.alter_column(u'ippc_publication', 'publication_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Poll.polltext'
        db.alter_column(u'ippc_poll', 'polltext', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))
