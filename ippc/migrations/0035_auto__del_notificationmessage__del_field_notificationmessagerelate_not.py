...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'ippc_notificationmessage')

        # Removing M2M table for field partners on 'NotificationMessage'
        db.delete_table(db.shorten_name(u'ippc_notificationmessage_partners'))

        # Removing M2M table for field countries on 'NotificationMessage'
        db.delete_table(db.shorten_name(u'ippc_notificationmessage_countries'))

        # Deleting field 'NotificationMessageRelate.notification'
        db.delete_column(u'ippc_notificationmessagerelate', 'notification_id')

        # Adding field 'NotificationMessageRelate.notifysecretariat'
        db.add_column(u'ippc_notificationmessagerelate', 'notifysecretariat',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'ippc_notificationmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notifysecretariat', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'ippc', ['NotificationMessage'])

        # Adding M2M table for field partners on 'NotificationMessage'
        m2m_table_name = db.shorten_name(u'ippc_notificationmessage_partners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notificationmessage', models.ForeignKey(orm[u'ippc.notificationmessage'], null=False)),
            ('partnerspage', models.ForeignKey(orm[u'ippc.partnerspage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['notificationmessage_id', 'partnerspage_id'])

        # Adding M2M table for field countries on 'NotificationMessage'
        m2m_table_name = db.shorten_name(u'ippc_notificationmessage_countries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notificationmessage', models.ForeignKey(orm[u'ippc.notificationmessage'], null=False)),
            ('countrypage', models.ForeignKey(orm[u'ippc.countrypage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['notificationmessage_id', 'countrypage_id'])

        # Adding field 'NotificationMessageRelate.notification'
        db.add_column(u'ippc_notificationmessagerelate', 'notification',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ippc.NotificationMessage'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NotificationMessageRelate.notifysecretariat'
        db.delete_column(u'ippc_notificationmessagerelate', 'notifysecretariat')
