...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryPage.country'
        db.add_column(u'ippc_countrypage', 'country',
                      self.gf('django_countries.fields.CountryField')(default='Italy', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountryPage.country'
        db.delete_column(u'ippc_countrypage', 'country')
    ...
    models = {
        ...
        u'ippc.countrypage': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'CountryPage', '_ormbases': [u'pages.Page']},
