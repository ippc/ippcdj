...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TransReportingObligation.content'
        db.delete_column(u'ippc_transreportingobligation', 'content')

        # Adding field 'TransReportingObligation.short_description'
        db.add_column(u'ippc_transreportingobligation', 'short_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TransReportingObligation.content'
        db.add_column(u'ippc_transreportingobligation', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)

        # Deleting field 'TransReportingObligation.short_description'
        db.delete_column(u'ippc_transreportingobligation', 'short_description')
    ...
    models = {
        ...
        u'ippc.transreportingobligation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'short_description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
