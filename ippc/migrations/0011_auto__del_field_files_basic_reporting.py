...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Files.basic_reporting'
        db.delete_column(u'ippc_files', 'basic_reporting_id')


    def backwards(self, orm):
        # Adding field 'Files.basic_reporting'
        db.add_column(u'ippc_files', 'basic_reporting',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['ippc.BasicReporting']),
                      keep_default=False)
