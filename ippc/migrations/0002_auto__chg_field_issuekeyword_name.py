...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueKeyword.name'
        db.alter_column(u'ippc_issuekeyword', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'IssueKeyword.name'
        db.alter_column(u'ippc_issuekeyword', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))
