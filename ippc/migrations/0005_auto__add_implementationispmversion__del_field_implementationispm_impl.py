...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImplementationISPM.implementimport_version'
        db.delete_column(u'ippc_implementationispm', 'implementimport_version')

        # Deleting field 'ImplementationISPM.implementexport_version'
        db.delete_column(u'ippc_implementationispm', 'implementexport_version')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ImplementationISPM.implementimport_version'
        db.add_column(u'ippc_implementationispm', 'implementimport_version',
                      self.gf('django.db.models.fields.IntegerField')(default='2002'),
                      keep_default=False)

        # Adding field 'ImplementationISPM.implementexport_version'
        db.add_column(u'ippc_implementationispm', 'implementexport_version',
                      self.gf('django.db.models.fields.IntegerField')(default='2002'),
                      keep_default=False)
