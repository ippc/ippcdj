...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IppcUserProfile.title'
        db.add_column(u'ippc_ippcuserprofile', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IppcUserProfile.address_country'
        db.add_column(u'ippc_ippcuserprofile', 'address_country',
                      self.gf('django_countries.fields.CountryField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IppcUserProfile.title'
        db.delete_column(u'ippc_ippcuserprofile', 'title')

        # Deleting field 'IppcUserProfile.address_country'
        db.delete_column(u'ippc_ippcuserprofile', 'address_country')
