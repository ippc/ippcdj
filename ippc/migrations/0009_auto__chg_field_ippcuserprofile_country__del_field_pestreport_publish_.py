...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ippc_ippcuserprofile', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ippc.CountryPage']))
        # Deleting field 'PestReport.publish_date'
        db.delete_column(u'ippc_pestreport', 'publish_date')

        # Deleting field 'PestReport.slug'
        db.delete_column(u'ippc_pestreport', 'slug')

        # Deleting field 'PestReport.title'
        db.delete_column(u'ippc_pestreport', 'title')

        # Deleting field 'PestReport.is_public'
        db.delete_column(u'ippc_pestreport', 'is_public')


    def backwards(self, orm):

        # Changing field 'IppcUserProfile.country'
        db.alter_column(u'ippc_ippcuserprofile', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default='italy', to=orm['ippc.CountryPage']))
        # Adding field 'PestReport.publish_date'
        db.add_column(u'ippc_pestreport', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PestReport.slug'
        db.add_column(u'ippc_pestreport', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PestReport.title'
        db.add_column(u'ippc_pestreport', 'title',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 8, 2, 0, 0), max_length=500),
                      keep_default=False)

        # Adding field 'PestReport.is_public'
        db.add_column(u'ippc_pestreport', 'is_public',
