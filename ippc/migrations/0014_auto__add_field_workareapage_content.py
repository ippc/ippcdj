...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkAreaPage.content'
        db.add_column(u'ippc_workareapage', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkAreaPage.content'
        db.delete_column(u'ippc_workareapage', 'content')
