...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NotificationMessageRelate.notification'
        db.alter_column(u'ippc_notificationmessagerelate', 'notification_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ippc.NotificationMessage'], unique=True, null=True))
        # Adding unique constraint on 'NotificationMessageRelate', fields ['notification']
        db.create_unique(u'ippc_notificationmessagerelate', ['notification_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NotificationMessageRelate', fields ['notification']
        db.delete_unique(u'ippc_notificationmessagerelate', ['notification_id'])


        # Changing field 'NotificationMessageRelate.notification'
        db.alter_column(u'ippc_notificationmessagerelate', 'notification_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.NotificationMessage'], null=True))
    ...
    models = {
        ...
        u'ippc.notificationmessagerelate': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notification': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ippc.NotificationMessage']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'ippc.partnersnews': {
