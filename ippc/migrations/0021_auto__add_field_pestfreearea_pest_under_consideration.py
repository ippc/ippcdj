...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PestFreeArea.pest_under_consideration'
        db.add_column(u'ippc_pestfreearea', 'pest_under_consideration',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PestFreeArea.pest_under_consideration'
        db.delete_column(u'ippc_pestfreearea', 'pest_under_consideration')
