...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ippc_implementationispm', (
            ...
            ('implementimport_version', self.gf('django.db.models.fields.IntegerField')(default=None)),
            ('implementexport_type', self.gf('django.db.models.fields.IntegerField')(default=None)),
            ('implementexport_version', self.gf('django.db.models.fields.IntegerField')(default=None)),
    ...
    models = {
        ...
        u'ippc.implementationispm': {
            ...
            'implementexport_version': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'implementimport_type': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'implementimport_version': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'in_sitemap': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'keywords': ('mezzanine.generic.fields.KeywordsField', [], {'object_id_field': "'object_pk'", 'to': u"orm['generic.AssignedKeyword']", 'frozen_by_south': 'True'}),
            'keywords_string': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
