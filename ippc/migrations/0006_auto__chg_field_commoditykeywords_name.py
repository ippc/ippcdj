...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommodityKeywords.name'
        db.alter_column(u'ippc_commoditykeywords', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'CommodityKeywords.name'
        db.alter_column(u'ippc_commoditykeywords', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))
