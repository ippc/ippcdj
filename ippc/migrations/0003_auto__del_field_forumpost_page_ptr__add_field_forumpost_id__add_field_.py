...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ForumPost.page_ptr'
        db.delete_column(u'ippc_forumpost', u'page_ptr_id')

        # Adding field 'ForumPost.id'
        db.add_column(u'ippc_forumpost', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'ForumPost.keywords_string'
        db.add_column(u'ippc_forumpost', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.site'
        db.add_column(u'ippc_forumpost', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'ForumPost.title'
        db.add_column(u'ippc_forumpost', 'title',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=500),
                      keep_default=False)

        # Adding field 'ForumPost.slug'
        db.add_column(u'ippc_forumpost', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost._meta_title'
        db.add_column(u'ippc_forumpost', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.description'
        db.add_column(u'ippc_forumpost', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.gen_description'
        db.add_column(u'ippc_forumpost', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ForumPost.status'
        db.add_column(u'ippc_forumpost', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'ForumPost.publish_date'
        db.add_column(u'ippc_forumpost', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.expiry_date'
        db.add_column(u'ippc_forumpost', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.short_url'
        db.add_column(u'ippc_forumpost', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.in_sitemap'
        db.add_column(u'ippc_forumpost', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ForumPost.user'
        db.add_column(u'ippc_forumpost', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='5', related_name='forumposts', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ForumPost.page_ptr'
        db.add_column(u'ippc_forumpost', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'ForumPost.id'
        db.delete_column(u'ippc_forumpost', u'id')

        # Deleting field 'ForumPost.keywords_string'
        db.delete_column(u'ippc_forumpost', 'keywords_string')

        # Deleting field 'ForumPost.site'
        db.delete_column(u'ippc_forumpost', 'site_id')

        # Deleting field 'ForumPost.title'
        db.delete_column(u'ippc_forumpost', 'title')

        # Deleting field 'ForumPost.slug'
        db.delete_column(u'ippc_forumpost', 'slug')

        # Deleting field 'ForumPost._meta_title'
        db.delete_column(u'ippc_forumpost', '_meta_title')

        # Deleting field 'ForumPost.description'
        db.delete_column(u'ippc_forumpost', 'description')

        # Deleting field 'ForumPost.gen_description'
        db.delete_column(u'ippc_forumpost', 'gen_description')

        # Deleting field 'ForumPost.status'
        db.delete_column(u'ippc_forumpost', 'status')

        # Deleting field 'ForumPost.publish_date'
        db.delete_column(u'ippc_forumpost', 'publish_date')

        # Deleting field 'ForumPost.expiry_date'
        db.delete_column(u'ippc_forumpost', 'expiry_date')

        # Deleting field 'ForumPost.short_url'
        db.delete_column(u'ippc_forumpost', 'short_url')

        # Deleting field 'ForumPost.in_sitemap'
        db.delete_column(u'ippc_forumpost', 'in_sitemap')

        # Deleting field 'ForumPost.user'
        db.delete_column(u'ippc_forumpost', 'user_id')
