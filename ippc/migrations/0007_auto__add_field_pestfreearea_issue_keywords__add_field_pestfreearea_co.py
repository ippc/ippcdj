...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ippc_pestfreearea', 'issue_keywords',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PestFreeArea.commodity_keywords'
        db.add_column(u'ippc_pestfreearea', 'commodity_keywords',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'EventReporting.issue_keywords'
        db.add_column(u'ippc_eventreporting', 'issue_keywords',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'BasicReporting.issue_keywords'
        db.add_column(u'ippc_basicreporting', 'issue_keywords',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicReporting.commodity_keywords'
        db.add_column(u'ippc_basicreporting', 'commodity_keywords',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventReporting.issue_keywords'
        db.delete_column(u'ippc_eventreporting', 'issue_keywords_id')

        # Deleting field 'EventReporting.commodity_keywords'
        db.delete_column(u'ippc_eventreporting', 'commodity_keywords_id')

        # Deleting field 'BasicReporting.issue_keywords'
        db.delete_column(u'ippc_basicreporting', 'issue_keywords_id')

        # Deleting field 'BasicReporting.commodity_keywords'
        db.delete_column(u'ippc_basicreporting', 'commodity_keywords_id')
    ...
    models = {
        ...
        u'ippc.basicreporting': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'basic_reporting_author'", 'to': u"orm['auth.User']"}),
            'basic_rep_type': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'commodity_keywords': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.CommodityKeywords']", 'null': 'True', 'blank': 'True'}),
            'contact_for_more_information': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'basic_reporting_country_page'", 'to': u"orm['ippc.CountryPage']"}),
            ...
            'issue_keywords': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.IssueKeywords']", 'null': 'True', 'blank': 'True'}),
        ...
        u'ippc.commoditykeywords': {
            'Meta': {'object_name': 'CommodityKeywords'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ippc.issuekeywords': {
            'Meta': {'object_name': 'IssueKeywords'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ippc.pestreport': {
            ...
            'pest_identity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.EppoCodes']", 'null': 'True', 'blank': 'True'}),
