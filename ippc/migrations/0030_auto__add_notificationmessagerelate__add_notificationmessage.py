...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field issuename on 'NotificationMessageRelate'
        m2m_table_name = db.shorten_name(u'ippc_notificationmessagerelate_issuename')
        ...
        db.create_unique(m2m_table_name, ['notificationmessagerelate_id', 'notificationmessage_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field issuename on 'NotificationMessageRelate'
        db.delete_table(db.shorten_name(u'ippc_notificationmessagerelate_issuename'))
    ...
    models = {
        ...
        u'ippc.notificationmessagerelate': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issuename': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['ippc.NotificationMessage']", 'null': 'True', 'blank': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'ippc.partnersnews': {
