...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'ippc_publication', 'author_id')


    def backwards(self, orm):
        # Adding field 'Publication.author'
        db.add_column(u'ippc_publication', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='publication_author', to=orm['auth.User']),
                      keep_default=False)
