...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'ippc_emailmessage')

        # Removing M2M table for field groups on 'EmailMessage'
        db.delete_table(db.shorten_name(u'ippc_emailmessage_groups'))

        # Removing M2M table for field users on 'EmailMessage'
        db.delete_table(db.shorten_name(u'ippc_emailmessage_users'))

        # Deleting model 'EmailMessageFile'
        db.delete_table(u'ippc_emailmessagefile')
        ...
        db.create_table(u'ippc_emailutilitymessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('emailfrom', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('emailto', self.gf('django.db.models.fields.CharField')(max_length=200)),
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'ippc_emailmessage', (
            ('emailfrom', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('emailto', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'ippc', ['EmailMessage'])

        # Adding M2M table for field groups on 'EmailMessage'
        m2m_table_name = db.shorten_name(u'ippc_emailmessage_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('emailmessage', models.ForeignKey(orm[u'ippc.emailmessage'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['emailmessage_id', 'group_id'])

        # Adding M2M table for field users on 'EmailMessage'
        m2m_table_name = db.shorten_name(u'ippc_emailmessage_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('emailmessage', models.ForeignKey(orm[u'ippc.emailmessage'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['emailmessage_id', 'user_id'])

        # Adding model 'EmailMessageFile'
        db.create_table(u'ippc_emailmessagefile', (
            ('emailmessage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.EmailMessage'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'ippc', ['EmailMessageFile'])
    ...
    models = {
        ...
        u'ippc.emailutilitymessage': {
            ...
            'emailfrom': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
