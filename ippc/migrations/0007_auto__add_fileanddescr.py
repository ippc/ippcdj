...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FileAndDescr'
        db.create_table(u'ippc_fileanddescr', (
        ...
        db.send_create_signal(u'ippc', ['FileAndDescr'])


    def backwards(self, orm):
        # Deleting model 'FileAndDescr'
        db.delete_table(u'ippc_fileanddescr')
    ...
    models = {
        ...
        u'ippc.filerelate': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'files_doc': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['ippc.Files']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'ippc.files': {
