...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PestReport.files'
        db.delete_column(u'ippc_pestreport', 'files')

        # Adding field 'PestReport.file'
        db.add_column(u'ippc_pestreport', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2013, 7, 22, 0, 0), max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PestReport.files'
        db.add_column(u'ippc_pestreport', 'files',
                      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2013, 7, 22, 0, 0), max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'PestReport.file'
        db.delete_column(u'ippc_pestreport', 'file')
