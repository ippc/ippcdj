...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PestReport.author'
        db.add_column(u'ippc_pestreport', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pest_report_author', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PestReport.author'
        db.delete_column(u'ippc_pestreport', 'author_id')
