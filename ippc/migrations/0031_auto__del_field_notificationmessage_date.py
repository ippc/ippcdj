...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NotificationMessage.date'
        db.delete_column(u'ippc_notificationmessage', 'date')


    def backwards(self, orm):
        # Adding field 'NotificationMessage.date'
        db.add_column(u'ippc_notificationmessage', 'date',
