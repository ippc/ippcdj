...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnersPage.content'
        db.add_column(u'ippc_partnerspage', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnersPage.content'
        db.delete_column(u'ippc_partnerspage', 'content')
