...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IppcUserProfile.date_account_created'
        db.add_column(u'ippc_ippcuserprofile', 'date_account_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IppcUserProfile.date_account_created'
        db.delete_column(u'ippc_ippcuserprofile', 'date_account_created')
