...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ippc_files', (
            ...
            ('basic_reporting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.BasicReporting'])),
    ...
    models = {
        ...
        u'ippc.files': {
            ...
            'basic_reporting': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.BasicReporting']"}),
