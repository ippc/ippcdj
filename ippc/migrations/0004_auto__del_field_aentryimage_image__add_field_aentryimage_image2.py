...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AEntryImage.image'
        db.delete_column(u'ippc_aentryimage', 'image')

        # Adding field 'AEntryImage.image2'
        db.add_column(u'ippc_aentryimage', 'image2',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AEntryImage.image'
        db.add_column(u'ippc_aentryimage', 'image',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'AEntryImage.image2'
        db.delete_column(u'ippc_aentryimage', 'image2')
    ...
    models = {
        ...
        u'ippc.aentryimage': {
            'Meta': {'object_name': 'AEntryImage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image2': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
        ...
        u'ippc.reportingobligation': {
            ...
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['ippc.AEntryImage']", 'null': 'True', 'blank': 'True'}),
            'in_sitemap': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'keywords': ('mezzanine.generic.fields.KeywordsField', [], {'object_id_field': "'object_pk'", 'to': u"orm['generic.AssignedKeyword']", 'frozen_by_south': 'True'}),
            'keywords_string': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
