...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IppcUserProfile.bio'
        db.alter_column(u'ippc_ippcuserprofile', 'bio', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'IppcUserProfile.email_address_alt'
        db.alter_column(u'ippc_ippcuserprofile', 'email_address_alt', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'IppcUserProfile.bio'
        db.alter_column(u'ippc_ippcuserprofile', 'bio', self.gf('django.db.models.fields.TextField')(default='hello'))

        # Changing field 'IppcUserProfile.email_address_alt'
        db.alter_column(u'ippc_ippcuserprofile', 'email_address_alt', self.gf('django.db.models.fields.EmailField')(default='alt email', max_length=75))
    ...
    models = {
        ...
        u'ippc.ippcuserprofile': {
            ...
            'email_address_alt': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
