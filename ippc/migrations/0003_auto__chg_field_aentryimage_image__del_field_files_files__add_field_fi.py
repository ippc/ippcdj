...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AEntryImage.image'
        db.alter_column(u'ippc_aentryimage', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AEntryImage.image'
        db.alter_column(u'ippc_aentryimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
