...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImplementationISPM.image'
        db.add_column(u'ippc_implementationispm', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='2002', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImplementationISPM.image'
        db.delete_column(u'ippc_implementationispm', 'image')
