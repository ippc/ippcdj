...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestEntry.name'
        db.add_column(u'ippc_testentry', 'name',
    ...
    def backwards(self, orm):
        # Deleting field 'TestEntry.name'
        db.delete_column(u'ippc_testentry', 'name')
        ...
        db.create_unique(m2m_table_name, ['testentry_id', 'testkeyword_id'])
