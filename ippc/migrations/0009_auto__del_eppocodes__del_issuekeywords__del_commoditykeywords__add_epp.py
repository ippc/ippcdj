...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'IssueKeywords'
        db.delete_table(u'ippc_issuekeywords')

        # Deleting model 'CommodityKeywords'
        db.delete_table(u'ippc_commoditykeywords')
        ...
        # Changing field 'PestFreeArea.issue_keywords'
        db.alter_column(u'ippc_pestfreearea', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeyword'], null=True))

        # Changing field 'PestFreeArea.commodity_keywords'
        db.alter_column(u'ippc_pestfreearea', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeyword'], null=True))

        # Changing field 'ImplementationISPM.issue_keywords'
        db.alter_column(u'ippc_implementationispm', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeyword'], null=True))

        # Changing field 'ImplementationISPM.commodity_keywords'
        db.alter_column(u'ippc_implementationispm', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeyword'], null=True))

        # Changing field 'EventReporting.issue_keywords'
        db.alter_column(u'ippc_eventreporting', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeyword'], null=True))

        # Changing field 'EventReporting.commodity_keywords'
        db.alter_column(u'ippc_eventreporting', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeyword'], null=True))

        # Changing field 'ReportingObligation.issue_keywords'
        db.alter_column(u'ippc_reportingobligation', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeyword'], null=True))

        # Changing field 'ReportingObligation.commodity_keywords'
        db.alter_column(u'ippc_reportingobligation', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeyword'], null=True))

        # Changing field 'PestReport.pest_identity'
        db.alter_column(u'ippc_pestreport', 'pest_identity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.EppoCode'], null=True))

        # Changing field 'PestReport.issue_keywords'
        db.alter_column(u'ippc_pestreport', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeyword'], null=True))

        # Changing field 'PestReport.commodity_keywords'
        db.alter_column(u'ippc_pestreport', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeyword'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding model 'IssueKeywords'
        db.create_table(u'ippc_issuekeywords', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'ippc', ['IssueKeywords'])

        # Adding model 'CommodityKeywords'
        db.create_table(u'ippc_commoditykeywords', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'ippc', ['CommodityKeywords'])
        ...
        # Changing field 'PestFreeArea.issue_keywords'
        db.alter_column(u'ippc_pestfreearea', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True))

        # Changing field 'PestFreeArea.commodity_keywords'
        db.alter_column(u'ippc_pestfreearea', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True))

        # Changing field 'ImplementationISPM.issue_keywords'
        db.alter_column(u'ippc_implementationispm', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True))

        # Changing field 'ImplementationISPM.commodity_keywords'
        db.alter_column(u'ippc_implementationispm', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True))

        # Changing field 'EventReporting.issue_keywords'
        db.alter_column(u'ippc_eventreporting', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True))

        # Changing field 'EventReporting.commodity_keywords'
        db.alter_column(u'ippc_eventreporting', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True))

        # Changing field 'ReportingObligation.issue_keywords'
        db.alter_column(u'ippc_reportingobligation', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True))

        # Changing field 'ReportingObligation.commodity_keywords'
        db.alter_column(u'ippc_reportingobligation', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True))

        # Changing field 'PestReport.pest_identity'
        db.alter_column(u'ippc_pestreport', 'pest_identity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.EppoCodes'], null=True))

        # Changing field 'PestReport.issue_keywords'
        db.alter_column(u'ippc_pestreport', 'issue_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.IssueKeywords'], null=True))

        # Changing field 'PestReport.commodity_keywords'
        db.alter_column(u'ippc_pestreport', 'commodity_keywords_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.CommodityKeywords'], null=True))
