...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartnerPublication.partners'
        db.add_column(u'ippc_partnerpublication', 'partners',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='partnerpublication_country_page', to=orm['ippc.PartnersPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PartnerPublication.partner'
        db.add_column(u'ippc_partnerpublication', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='partnerpublication_country_page', to=orm['ippc.PartnersPage']),
                      keep_default=False)

        # Deleting field 'PartnerPublication.partners'
        db.delete_column(u'ippc_partnerpublication', 'partners_id')
    ...
    models = {
        ...
        u'ippc.partnerpublication': {
            'Meta': {'object_name': 'PartnerPublication'},
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'agenda_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'partnerpublication_author'", 'to': u"orm['auth.User']"}),
            'contact_for_more_information': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'document_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'old_id': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'partners': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'partnerpublication_country_page'", 'to': u"orm['ippc.PartnersPage']"}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'short_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'ippc.partnerpublicationfile': {
            'Meta': {'object_name': 'PartnerPublicationFile'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'partnerpublication': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.PartnerPublication']"})
        },
        u'ippc.partnerpublicationurl': {
            'Meta': {'object_name': 'PartnerPublicationUrl'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'partnerpublication': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.PartnerPublication']"}),
            'url_for_more_information': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
