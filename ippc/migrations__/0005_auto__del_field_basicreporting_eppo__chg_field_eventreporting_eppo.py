...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BasicReporting.eppo'
        db.delete_column(u'ippc_basicreporting', 'eppo_id')


        # Changing field 'EventReporting.eppo'
        db.alter_column(u'ippc_eventreporting', 'eppo_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['ippc.EppoCodes']))

    def backwards(self, orm):
        # Adding field 'BasicReporting.eppo'
        db.add_column(u'ippc_basicreporting', 'eppo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.EppoCodes'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'EventReporting.eppo'
        db.alter_column(u'ippc_eventreporting', 'eppo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ippc.EppoCodes'], null=True))
    ...
    models = {
        ...
        u'ippc.eventreporting': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'eppo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ippc.EppoCodes']"}),
