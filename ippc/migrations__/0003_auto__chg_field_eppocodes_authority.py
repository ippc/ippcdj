...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EppoCodes.authority'
        db.alter_column(u'ippc_eppocodes', 'authority', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'EppoCodes.authority'
        db.alter_column(u'ippc_eppocodes', 'authority', self.gf('django.db.models.fields.CharField')(max_length=500))
