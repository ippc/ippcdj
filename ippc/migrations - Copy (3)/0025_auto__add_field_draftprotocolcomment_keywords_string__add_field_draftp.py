...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DraftProtocolComment.keywords_string'
        db.add_column(u'ippc_draftprotocolcomment', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.site'
        db.add_column(u'ippc_draftprotocolcomment', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.title'
        db.add_column(u'ippc_draftprotocolcomment', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.slug'
        db.add_column(u'ippc_draftprotocolcomment', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment._meta_title'
        db.add_column(u'ippc_draftprotocolcomment', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.description'
        db.add_column(u'ippc_draftprotocolcomment', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.gen_description'
        db.add_column(u'ippc_draftprotocolcomment', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.status'
        db.add_column(u'ippc_draftprotocolcomment', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.publish_date'
        db.add_column(u'ippc_draftprotocolcomment', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.expiry_date'
        db.add_column(u'ippc_draftprotocolcomment', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.short_url'
        db.add_column(u'ippc_draftprotocolcomment', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DraftProtocolComment.in_sitemap'
        db.add_column(u'ippc_draftprotocolcomment', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DraftProtocolComment.keywords_string'
        db.delete_column(u'ippc_draftprotocolcomment', 'keywords_string')

        # Deleting field 'DraftProtocolComment.site'
        db.delete_column(u'ippc_draftprotocolcomment', 'site_id')

        # Deleting field 'DraftProtocolComment.title'
        db.delete_column(u'ippc_draftprotocolcomment', 'title')

        # Deleting field 'DraftProtocolComment.slug'
        db.delete_column(u'ippc_draftprotocolcomment', 'slug')

        # Deleting field 'DraftProtocolComment._meta_title'
        db.delete_column(u'ippc_draftprotocolcomment', '_meta_title')

        # Deleting field 'DraftProtocolComment.description'
        db.delete_column(u'ippc_draftprotocolcomment', 'description')

        # Deleting field 'DraftProtocolComment.gen_description'
        db.delete_column(u'ippc_draftprotocolcomment', 'gen_description')

        # Deleting field 'DraftProtocolComment.status'
        db.delete_column(u'ippc_draftprotocolcomment', 'status')

        # Deleting field 'DraftProtocolComment.publish_date'
        db.delete_column(u'ippc_draftprotocolcomment', 'publish_date')

        # Deleting field 'DraftProtocolComment.expiry_date'
        db.delete_column(u'ippc_draftprotocolcomment', 'expiry_date')

        # Deleting field 'DraftProtocolComment.short_url'
        db.delete_column(u'ippc_draftprotocolcomment', 'short_url')

        # Deleting field 'DraftProtocolComment.in_sitemap'
        db.delete_column(u'ippc_draftprotocolcomment', 'in_sitemap')
