...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImplementationISPMVersion.version'
        db.alter_column(u'ippc_implementationispmversion', 'version', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'ImplementationISPMVersion.version'
        db.alter_column(u'ippc_implementationispmversion', 'version', self.gf('django.db.models.fields.CharField')(max_length=2))
