...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PestReport.keywords_string'
        db.add_column(u'ippc_pestreport', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'PestReport.site'
        db.add_column(u'ippc_pestreport', 'site',
        ...
        # Adding field 'PestReport._meta_title'
        db.add_column(u'ippc_pestreport', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PestReport.description'
        db.add_column(u'ippc_pestreport', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PestReport.gen_description'
        db.add_column(u'ippc_pestreport', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PestReport.status'
        db.add_column(u'ippc_pestreport', 'status',
        ...
        # Adding field 'PestReport.expiry_date'
        db.add_column(u'ippc_pestreport', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PestReport.short_url'
        db.add_column(u'ippc_pestreport', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PestReport.in_sitemap'
        db.add_column(u'ippc_pestreport', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CountryPage.contact_point'
        db.add_column(u'ippc_countrypage', 'contact_point',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PestReport.keywords_string'
        db.delete_column(u'ippc_pestreport', 'keywords_string')

        # Deleting field 'PestReport.site'
        db.delete_column(u'ippc_pestreport', 'site_id')
        ...
        # Deleting field 'PestReport._meta_title'
        db.delete_column(u'ippc_pestreport', '_meta_title')

        # Deleting field 'PestReport.description'
        db.delete_column(u'ippc_pestreport', 'description')

        # Deleting field 'PestReport.gen_description'
        db.delete_column(u'ippc_pestreport', 'gen_description')

        # Deleting field 'PestReport.status'
        db.delete_column(u'ippc_pestreport', 'status')

        # Deleting field 'PestReport.publish_date'
        db.delete_column(u'ippc_pestreport', 'publish_date')

        # Deleting field 'PestReport.expiry_date'
        db.delete_column(u'ippc_pestreport', 'expiry_date')

        # Deleting field 'PestReport.short_url'
        db.delete_column(u'ippc_pestreport', 'short_url')

        # Deleting field 'PestReport.in_sitemap'
        db.delete_column(u'ippc_pestreport', 'in_sitemap')

        # Deleting field 'CountryPage.contact_point'
        db.delete_column(u'ippc_countrypage', 'contact_point_id')
