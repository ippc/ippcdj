...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'IppcUserProfile.country' to match new field type.
        db.rename_column(u'ippc_ippcuserprofile', 'country', 'country_id')
        # Changing field 'IppcUserProfile.country'
        db.alter_column(u'ippc_ippcuserprofile', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['ippc.CountryPage']))
        # Adding index on 'IppcUserProfile', fields ['country']
        db.create_index(u'ippc_ippcuserprofile', ['country_id'])

        # Adding field 'CountryPage.iso3'
        db.add_column(u'ippc_countrypage', 'iso3',
                      self.gf('django.db.models.fields.CharField')(max_length=3, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'CountryPage', fields ['country_slug']
        db.create_unique(u'ippc_countrypage', ['country_slug'])
        ...
        # Changing field 'CountryPage.iso'
        db.alter_column(u'ippc_countrypage', 'iso', self.gf('django.db.models.fields.CharField')(max_length=2, unique=True, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'CountryPage', fields ['country_slug']
        db.delete_unique(u'ippc_countrypage', ['country_slug'])

        # Removing index on 'IppcUserProfile', fields ['country']
        db.delete_index(u'ippc_ippcuserprofile', ['country_id'])


        # Renaming column for 'IppcUserProfile.country' to match new field type.
        db.rename_column(u'ippc_ippcuserprofile', 'country_id', 'country')
        # Changing field 'IppcUserProfile.country'
        db.alter_column(u'ippc_ippcuserprofile', 'country', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))
        # Deleting field 'CountryPage.iso3'
        db.delete_column(u'ippc_countrypage', 'iso3')
        ...
        # Changing field 'CountryPage.iso'
        db.alter_column(u'ippc_countrypage', 'iso', self.gf('django.db.models.fields.CharField')(max_length=2, primary_key=True))
    ...
    models = {
        ...
        u'ippc.ippcuserprofile': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_country_page'", 'to': u"orm['ippc.CountryPage']"}),
        ...
        u'ippc.pestreport': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
