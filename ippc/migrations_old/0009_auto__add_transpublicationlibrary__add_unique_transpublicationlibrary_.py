...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransPublicationLibrary'
        db.create_table(u'ippc_transpublicationlibrary', (
        ...
        db.send_create_signal(u'ippc', ['TransPublicationLibrary'])

        # Adding unique constraint on 'TransPublicationLibrary', fields ['lang', 'translation']
        db.create_unique(u'ippc_transpublicationlibrary', ['lang', 'translation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TransPublicationLibrary', fields ['lang', 'translation']
        db.delete_unique(u'ippc_transpublicationlibrary', ['lang', 'translation_id'])

        # Deleting model 'TransPublicationLibrary'
        db.delete_table(u'ippc_transpublicationlibrary')
    ...
    models = {
        ...
        u'ippc.transpublicationlibrary': {
            'Meta': {'ordering': "('lang',)", 'unique_together': "(('lang', 'translation'),)", 'object_name': 'TransPublicationLibrary'},
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
