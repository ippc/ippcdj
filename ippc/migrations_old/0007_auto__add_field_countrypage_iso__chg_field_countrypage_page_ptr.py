...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ippc_countrypage', 'iso',
                      self.gf('django.db.models.fields.CharField')(default='it', max_length=2, primary_key=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'ippc.countrypage': {
            ...
            'iso': ('django.db.models.fields.CharField', [], {'default': "'it'", 'max_length': '2', 'primary_key': 'True'}),
