...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'pce_module1majorcrops', 'crops_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pce.Crops']))

    def backwards(self, orm):

        # Changing field 'Module1MajorCrops.crops'
        db.alter_column(u'pce_module1majorcrops', 'crops_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'pce.module1majorcrops': {
            ...
            'crops': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pce.Crops']"}),
