...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StakeholdersFields.organisation'
        db.add_column(u'pce_stakeholdersfields', 'organisation',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StakeholdersFields.organisation'
        db.delete_column(u'pce_stakeholdersfields', 'organisation')
