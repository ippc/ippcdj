...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module11.m_64'
        db.add_column(u'pce_module11', 'm_64',
                      self.gf('django.db.models.fields.IntegerField')(default=''),
                      keep_default=False)


        # Changing field 'Module3Grid.veryhigh'
        db.alter_column(u'pce_module3grid', 'veryhigh', self.gf('django.db.models.fields.BooleanField')(default=''))

        # Changing field 'Module3Grid.medium'
        db.alter_column(u'pce_module3grid', 'medium', self.gf('django.db.models.fields.BooleanField')(default=''))

        # Changing field 'Module3Grid.high'
        db.alter_column(u'pce_module3grid', 'high', self.gf('django.db.models.fields.BooleanField')(default=''))

        # Changing field 'Module3Grid.low'
        db.alter_column(u'pce_module3grid', 'low', self.gf('django.db.models.fields.BooleanField')(default=''))

        # Changing field 'Module3Grid.verylow'
        db.alter_column(u'pce_module3grid', 'verylow', self.gf('django.db.models.fields.BooleanField')(default=2))

    def backwards(self, orm):
        # Deleting field 'Module11.m_64'
        db.delete_column(u'pce_module11', 'm_64')
