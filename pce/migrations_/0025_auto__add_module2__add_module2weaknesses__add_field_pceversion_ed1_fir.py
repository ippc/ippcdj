...
#        db.send_create_signal(u'pce', ['Module2Weaknesses'])
        ...
        # Adding field 'PceVersion.ed1_firstname'
        db.add_column(u'pce_pceversion', 'ed1_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed1_lastname'
        db.add_column(u'pce_pceversion', 'ed1_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed1_email'
        db.add_column(u'pce_pceversion', 'ed1_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed2_firstname'
        db.add_column(u'pce_pceversion', 'ed2_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed2_lastname'
        db.add_column(u'pce_pceversion', 'ed2_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed2_email'
        db.add_column(u'pce_pceversion', 'ed2_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed3_firstname'
        db.add_column(u'pce_pceversion', 'ed3_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed3_lastname'
        db.add_column(u'pce_pceversion', 'ed3_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed3_email'
        db.add_column(u'pce_pceversion', 'ed3_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed4_firstname'
        db.add_column(u'pce_pceversion', 'ed4_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed4_lastname'
        db.add_column(u'pce_pceversion', 'ed4_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed4_email'
        db.add_column(u'pce_pceversion', 'ed4_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed5_firstname'
        db.add_column(u'pce_pceversion', 'ed5_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed5_lastname'
        db.add_column(u'pce_pceversion', 'ed5_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed5_email'
        db.add_column(u'pce_pceversion', 'ed5_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed6_firstname'
        db.add_column(u'pce_pceversion', 'ed6_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed6_lastname'
        db.add_column(u'pce_pceversion', 'ed6_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed6_email'
        db.add_column(u'pce_pceversion', 'ed6_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed7_firstname'
        db.add_column(u'pce_pceversion', 'ed7_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed7_lastname'
        db.add_column(u'pce_pceversion', 'ed7_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed7_email'
        db.add_column(u'pce_pceversion', 'ed7_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed8_firstname'
        db.add_column(u'pce_pceversion', 'ed8_firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed8_lastname'
        db.add_column(u'pce_pceversion', 'ed8_lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PceVersion.ed8_email'
        db.add_column(u'pce_pceversion', 'ed8_email',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SwotAnalysis4.weaknesses'
        db.delete_column(u'pce_swotanalysis4', 'weaknesses')

        # Deleting field 'SwotAnalysis5.weaknesses'
        db.delete_column(u'pce_swotanalysis5', 'weaknesses')

        # Deleting field 'SwotAnalysis1.weaknesses'
        db.delete_column(u'pce_swotanalysis1', 'weaknesses')

        # Deleting field 'SwotAnalysis2.weaknesses'
        db.delete_column(u'pce_swotanalysis2', 'weaknesses')

        # Deleting field 'SwotAnalysis3.weaknesses'
        db.delete_column(u'pce_swotanalysis3', 'weaknesses')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PceVersion.ed1_firstname'
        db.delete_column(u'pce_pceversion', 'ed1_firstname')

        # Deleting field 'PceVersion.ed1_lastname'
        db.delete_column(u'pce_pceversion', 'ed1_lastname')

        # Deleting field 'PceVersion.ed1_email'
        db.delete_column(u'pce_pceversion', 'ed1_email')

        # Deleting field 'PceVersion.ed2_firstname'
        db.delete_column(u'pce_pceversion', 'ed2_firstname')

        # Deleting field 'PceVersion.ed2_lastname'
        db.delete_column(u'pce_pceversion', 'ed2_lastname')

        # Deleting field 'PceVersion.ed2_email'
        db.delete_column(u'pce_pceversion', 'ed2_email')

        # Deleting field 'PceVersion.ed3_firstname'
        db.delete_column(u'pce_pceversion', 'ed3_firstname')

        # Deleting field 'PceVersion.ed3_lastname'
        db.delete_column(u'pce_pceversion', 'ed3_lastname')

        # Deleting field 'PceVersion.ed3_email'
        db.delete_column(u'pce_pceversion', 'ed3_email')

        # Deleting field 'PceVersion.ed4_firstname'
        db.delete_column(u'pce_pceversion', 'ed4_firstname')

        # Deleting field 'PceVersion.ed4_lastname'
        db.delete_column(u'pce_pceversion', 'ed4_lastname')

        # Deleting field 'PceVersion.ed4_email'
        db.delete_column(u'pce_pceversion', 'ed4_email')

        # Deleting field 'PceVersion.ed5_firstname'
        db.delete_column(u'pce_pceversion', 'ed5_firstname')

        # Deleting field 'PceVersion.ed5_lastname'
        db.delete_column(u'pce_pceversion', 'ed5_lastname')

        # Deleting field 'PceVersion.ed5_email'
        db.delete_column(u'pce_pceversion', 'ed5_email')

        # Deleting field 'PceVersion.ed6_firstname'
        db.delete_column(u'pce_pceversion', 'ed6_firstname')

        # Deleting field 'PceVersion.ed6_lastname'
        db.delete_column(u'pce_pceversion', 'ed6_lastname')

        # Deleting field 'PceVersion.ed6_email'
        db.delete_column(u'pce_pceversion', 'ed6_email')

        # Deleting field 'PceVersion.ed7_firstname'
        db.delete_column(u'pce_pceversion', 'ed7_firstname')

        # Deleting field 'PceVersion.ed7_lastname'
        db.delete_column(u'pce_pceversion', 'ed7_lastname')

        # Deleting field 'PceVersion.ed7_email'
        db.delete_column(u'pce_pceversion', 'ed7_email')

        # Deleting field 'PceVersion.ed8_firstname'
        db.delete_column(u'pce_pceversion', 'ed8_firstname')

        # Deleting field 'PceVersion.ed8_lastname'
        db.delete_column(u'pce_pceversion', 'ed8_lastname')

        # Deleting field 'PceVersion.ed8_email'
        db.delete_column(u'pce_pceversion', 'ed8_email')

        # Adding field 'SwotAnalysis4.weaknesses'
        db.add_column(u'pce_swotanalysis4', 'weaknesses',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SwotAnalysis5.weaknesses'
        db.add_column(u'pce_swotanalysis5', 'weaknesses',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SwotAnalysis1.weaknesses'
        db.add_column(u'pce_swotanalysis1', 'weaknesses',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SwotAnalysis2.weaknesses'
        db.add_column(u'pce_swotanalysis2', 'weaknesses',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SwotAnalysis3.weaknesses'
        db.add_column(u'pce_swotanalysis3', 'weaknesses',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'pce.module13grid22': {
            ...
            'c1': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'c2': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'c3': ('django.db.models.fields.IntegerField', [], {'default': '((True, <django.utils.functional.__proxy__ object at 0x03365B10>), (False, <django.utils.functional.__proxy__ object at 0x03365B50>))'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'module13': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pce.Module13']"})
        },
