...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Module1.modulecategory'
        db.delete_column(u'pce_module1', 'modulecategory_id')


    def backwards(self, orm):
        # Adding field 'Module1.modulecategory'
        db.add_column(u'pce_module1', 'modulecategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['pce.ModuleCategory']),
                      keep_default=False)
