...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Module1.m_22'
        db.delete_column(u'pce_module1', 'm_22')

        # Deleting field 'Module1.m_23'
        db.delete_column(u'pce_module1', 'm_23')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Module1.m_22'
        db.add_column(u'pce_module1', 'm_22',
                      self.gf('django.db.models.fields.IntegerField')(default=''),
                      keep_default=False)

        # Adding field 'Module1.m_23'
        db.add_column(u'pce_module1', 'm_23',
                      self.gf('django.db.models.fields.IntegerField')(default=''),
                      keep_default=False)
