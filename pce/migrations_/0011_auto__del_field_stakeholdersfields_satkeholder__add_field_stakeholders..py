...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StakeholdersFields.satkeholder'
        #db.delete_column(u'pce_stakeholdersfields', 'satkeholder_id')
        print()


    def backwards(self, orm):
        # Adding field 'StakeholdersFields.satkeholder'
        db.add_column(u'pce_stakeholdersfields', 'satkeholder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['pce.Stakeholders']),
                      keep_default=False)

        # Deleting field 'StakeholdersFields.stakeholder'
        db.delete_column(u'pce_stakeholdersfields', 'stakeholder_id')
