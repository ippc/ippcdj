...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Module10Matrix47'
        db.create_table(u'pce_module10matrix47', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module10', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pce.Module10'])),
        ...
        db.send_create_signal(u'pce', ['Module10Matrix47'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Module10Matrix47'
        db.delete_table(u'pce_module10matrix47')
    ...
    models = {
        ...
        u'pce.module10matrix47': {
            'Meta': {'object_name': 'Module10Matrix47'},
