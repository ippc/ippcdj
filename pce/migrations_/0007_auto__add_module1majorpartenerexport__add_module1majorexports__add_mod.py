...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Module1Aid.titleprj'
        db.alter_column(u'pce_module1aid', 'titleprj', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Module1Aid.date'
        db.alter_column(u'pce_module1aid', 'date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Module1Aid.amount'
        db.alter_column(u'pce_module1aid', 'amount', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Module1Aid.duration'
        db.alter_column(u'pce_module1aid', 'duration', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Module1Aid.donoragency'
        db.alter_column(u'pce_module1aid', 'donoragency', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Module1Aid.titleprj'
        db.alter_column(u'pce_module1aid', 'titleprj', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Module1Aid.date'
        db.alter_column(u'pce_module1aid', 'date', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Module1Aid.amount'
        db.alter_column(u'pce_module1aid', 'amount', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Module1Aid.duration'
        db.alter_column(u'pce_module1aid', 'duration', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Module1Aid.donoragency'
        db.alter_column(u'pce_module1aid', 'donoragency', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Module1MajorCrops.crops'
        db.alter_column(u'pce_module1majorcrops', 'crops', self.gf('django.db.models.fields.TextField')(null=True))
