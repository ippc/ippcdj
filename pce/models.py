...
class Module1(Displayable, models.Model):
    ...
    m_5= models.TextField(_("5. Total Arable Land - sq. km."), blank=True, null=True,help_text=_("Includes Agricultural land and Arable and permanent crop land") )
...
class Module3(Displayable, models.Model):
   ...
   # m_14 = models.ManyToManyField(M3_14,verbose_name=_("12. To what degree is he infrastructural environment supportive of the NPPOs ability to execute its mandate?"), blank=True, null=True,help_text=_("Consider infrastructure and equipment maintenance programmes, road systems, commuications systems, etc. "))
    ...
    m_14 = models.IntegerField(_("12. To what degree is the infrastructural environment supportive of the NPPO's ability to execute its mandate?"), choices=VAL_M3_14, default=None,help_text=_("Consider infrastructure and equipment maintenance programmes, road systems, commuications systems, etc. "),)
    ...
    m_23 = models.IntegerField(_("21. Rate the potential for constructive collaboration and other partnerships that might enhance the NPPO's output?"), choices=PRIORITY, default=None,help_text=_("For example with Universities or Research Centers... "),)
...
class Module4(Displayable, models.Model):
    ...
    m_13 = models.IntegerField(_("13. Has the strategy helped clarify priorities thus giving the NPPO a way to assess its performance?"), choices=DEGREE, default=None,help_text=_("Organization's performance is reflected in its effectiveness, efficiency, and sustainability. Effectiveness refers to the degree to which the organization achieves its goals. Efficiency refers to the degree it manages to minimize costs. Sustainability refers to the organization's continuing relevance and the ability to acquire the financial and other resources needed for its operations. Strategic management is the deployment and implementation of the strategic plan and measurement and evaluation of the results.  "),)
    ...
    m_16 = models.NullBooleanField(_("16. Has the NPPO a system of organizational incentives including rewards and punishments, to encourage or discourage its staff members' behaviors?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_31 = models.NullBooleanField(_("26. Has the NPPO an efficient written set of operational procedures or manuals?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" <br> <br> <br><i>If answer is <b>No</b> go to <b>Section II.</b></i>  "),)
...
class Module6(Displayable, models.Model):
    ...
    m_6 = models.NullBooleanField(_("4. Does the NPPO charge for the service it provides?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_("Some NPPOs may charge for all or certain of its services such as issuing certificates, inspection activities etc.  <br> <br> <br><i>If answer is <b>No</b> go to question <b>6.</b></i> "),)
    ...
    m_20 = models.NullBooleanField(_("17. Does the NPPO have a partnership agreement with other NPPOs or Universities, for the professional development of staff?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_("These agreeemnts can be at the local, regional or international levels. "),)
    ...
    m_27 = models.IntegerField(_("24. What is the level of the NPPO's capacity to inform its stakeholders at the national and international levels, of its activities and other relevant phytosanitary issues in an effective and timely manner?"),choices=CAPACITY, default=None,help_text=_(" "),)
    ...
    m_31 = models.IntegerField(_("28. Rate the NPPO's infrastructure resources at border inspection points:"),choices=BAD, default=None,help_text=_(" "),)
    m_32 = models.IntegerField(_("29. Rate the NPPO's resources for telecommunications:"),choices=BAD, default=None,help_text=_(" "),)
    m_33 = models.IntegerField(_("30. Rate the NPPO's vehicle resources:"),choices=BAD, default=None,help_text=_(" "),)
    m_34 = models.IntegerField(_("31. Rate the NPPO's resources for office equipment (computer, printers, projectors, etc)"),choices=BAD, default=None,help_text=_(" "),)
    m_35 = models.IntegerField(_("32. Rate the NPPO's maintenance systems resources:"),choices=BAD, default=None,help_text=_(" "),)
    m_36 = models.IntegerField(_("33. Rate the NPPO's technical and scientific library resources:"),choices=BAD, default=None,help_text=_(" "),)
   #m_37
    c_m_1= models.TextField(_("Comment"), blank=True, null=True,help_text=' ')
    c_m_2= models.TextField(_("Comment"), blank=True, null=True,help_text=' ');
    c_m_3= models.TextField(_("Comment"), blank=True, null=True,help_text=' ');
...
class Module7(Displayable, models.Model):
    ...
    m_4 = models.NullBooleanField(_("4. Is there a set of good indicators to measure the effectiveness of the pest diagnostic program?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_11= models.TextField(_("11. Which other laboratories carry out pest diagnostics in the country?"), blank=True, null=True,help_text=_(" "),)
    ...
    m_16 = models.NullBooleanField(_("16. Are there documented quality control procedures (e.g. to ISO 17025 or 9000 series standards) or good laboratory practices for laboratory operations of the NPPO's laboratory?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_36 = models.NullBooleanField(_("35. Are the methods and protocols for pest diagnostics documented in a form that is available to diagnosticians?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    # m_37 matrix
    ...
    m_52 = models.NullBooleanField(_("46. Are there functional safety devices available in the laboratory(ies)?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_("Examples of safety devices can include fume hoods, emergency showers, eye douche, fire extinguishers, fire blanket, first aid kits, etc. "),)
    ...
    m_59 = models.NullBooleanField(_("53. Do the NPPO's phytosanitary contingency plans take into account the required laboratory support?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_("<br> <br> <br><i>If answer is <b>No</b> go to <b>Section III.</b></i> "),)
...
class Module8(Displayable, models.Model):
    ...
    m_9= models.TextField(_("9. Which organizations carry out pest surveillance in the country?"), blank=True, null=True,help_text=_(" "),)
...
class Module9(Displayable, models.Model):
    ...
    m_16 = models.NullBooleanField(_("16. Does the management team have written responsibilities to carry out its functions effectively and in accordance with the international standards?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_27 = models.NullBooleanField(_("27. Do the NPPO's pest eradication programs have well developed and compatible data systems to collect, store and report pest distribution and eradication information?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    #m_35
    m_36 = models.IntegerField(_("36. Rate the current NPPO pest eradication program's human resources capacity in terms of numbers:"),choices=WEAK, default=None,help_text=_(" "),)
    m_37 = models.IntegerField(_("37. Rate the current NPPO pest eradication program's human resources capacity in terms of qualifications and skills:"),choices=INSUFF1, default=None,help_text=_(" "),)
...
class Module10(Displayable, models.Model):
    ...
    m_20 = models.NullBooleanField(_("19. Do the import regulatory system procedures or regulations specify that phytosanitary measures cannot be applied to non regulated pests?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
 ...
 # m_23
    m_24 = models.NullBooleanField(_("23. Does the import regulatory system cover consignments in transit and allow the NPPO to adopt technically justified measures as indicated in <a href='https://www.ippc.int/en/publications/595/' target='_blank'>ISPM 25</a>?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
...
class Module11(Displayable, models.Model):
   ...
   #m_14
    ...
    m_35 = models.NullBooleanField(_("35. Does the NPPO have a written procedure to liaise with relevant stakeholders to communicate the identified phytosanitary measures?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
...
class Module12(Displayable, models.Model):
    ...
    m_13 = models.NullBooleanField(_("13. Does the legislation allow the NPPO to adopt the phytosanitary procedures necessary to assure the phytosanitary security and integrity of consignments?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
...
class Module13(Displayable, models.Model):
    ...
    m_8= models.TextField(_("8. What indicators could be used to measure the status of the export certification services relevance?"), blank=True, null=True,help_text=_(" "),)
   ...
   #m_31
    ...
    m_33 = models.NullBooleanField(_("33. If required by the importing country, are all consignments and their certification traceable through all stages of production, handling and transport to the point of export?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_35 = models.NullBooleanField(_("35. Are the linkages with other NPPO's programs (pest diagnostics, surveillance, internal quarantine, and phytosanitary inspectors) well established in the export certification manual?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    m_36 = models.NullBooleanField(_("36. Does the NPPO have a system for liaising effectively with the NPPOs of importing countries to discuss phytosanitary requirements?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_41 = models.NullBooleanField(_("41. Are those certificates issued in accordance with the good practices for certificate issuance as established in <a href='https://www.ippc.int/en/publications/609/' target='_blank'>ISPM 12</a>?"), choices=BOOL_CHOICES,blank=True, null=True, help_text=_(" "),)
    ...
    m_63 = models.IntegerField(_("5. Has the export certification service kept its relevance over time?"),choices=WEAK, default=None,help_text=_(" "),)
    m_64= models.TextField(_("6. What indicators could be used to measure the status or the export certification services relevance?"), blank=True, null=True,help_text=_(" "),)
    m_65 = models.IntegerField(_("7. How well is the NPPO's export certification service performing?"),choices=WEAK, default=None,help_text=_(" "),)
    #m66
    #m_comment = models.TextField(_("Comment"), blank=True, null=True,help_text='Please put your comments here.')
    c_m_1= models.TextField(_("Comment"), blank=True, null=True,help_text=' ')
    c_m_2= models.TextField(_("Comment"), blank=True, null=True,help_text=' ');
