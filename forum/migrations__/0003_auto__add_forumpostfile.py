...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ForumPostFile'
        db.create_table(u'forum_forumpostfile', (
        ...
        db.send_create_signal(u'forum', ['ForumPostFile'])
    ...
    def backwards(self, orm):
        # Deleting model 'ForumPostFile'
        db.delete_table(u'forum_forumpostfile')
    ...
    models = {
        ...
        u'forum.forumpostfile': {
            'Meta': {'object_name': 'ForumPostFile'},
