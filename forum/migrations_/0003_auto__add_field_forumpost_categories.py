...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumPost.categories'
        db.add_column(u'forum_forumpost', 'categories',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='forumposts', to=orm['forum.ForumCategory']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ForumPost.categories'
        db.delete_column(u'forum_forumpost', 'categories_id')
    ...
    models = {
        ...
        u'forum.forumpost': {
            ...
            'categories': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forumposts'", 'to': u"orm['forum.ForumCategory']"}),
