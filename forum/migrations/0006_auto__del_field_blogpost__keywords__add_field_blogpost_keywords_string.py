...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ForumPost._keywords'
        db.delete_column('forum_forumpost', '_keywords')

        # Adding field 'ForumPost.keywords_string'
        db.add_column('forum_forumpost', 'keywords_string', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ForumPost._keywords'
        db.add_column('forum_forumpost', '_keywords', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)

        # Deleting field 'ForumPost.keywords_string'
        db.delete_column('forum_forumpost', 'keywords_string')
