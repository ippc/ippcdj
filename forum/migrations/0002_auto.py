...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_forumpost_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('forumpost', models.ForeignKey(orm['forum.forumpost'], null=False)),
            ('blogcategory', models.ForeignKey(orm['forum.blogcategory'], null=False))
        ))
        db.create_unique('forum_forumpost_categories', ['forumpost_id', 'blogcategory_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field categories on 'ForumPost'
        db.delete_table('forum_forumpost_categories')
    ...
    models = {
        ...
        'forum.forumpost': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['forum.ForumCategory']", 'symmetrical': 'False', 'blank': 'True'}),
