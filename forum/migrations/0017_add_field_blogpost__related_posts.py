...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_forumpost_related_posts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_forumpost', models.ForeignKey(orm['forum.forumpost'], null=False)),
            ('to_forumpost', models.ForeignKey(orm['forum.forumpost'], null=False))
        ))
        db.create_unique('forum_forumpost_related_posts', ['from_forumpost_id', 'to_forumpost_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_posts on 'ForumPost'
        db.delete_table('forum_forumpost_related_posts')
    ...
    models = {
        ...
        'forum.forumpost': {
            ...
            'related_posts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_posts_rel_+'", 'blank': 'True', 'to': "orm['forum.ForumPost']"}),
