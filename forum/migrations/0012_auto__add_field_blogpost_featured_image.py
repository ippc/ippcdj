...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumPost.featured_image'
        db.add_column('forum_forumpost', 'featured_image', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForumPost.featured_image'
        db.delete_column('forum_forumpost', 'featured_image')
