...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_forumpost', 'gen_description', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        if not db.dry_run:
            orm["forum.ForumPost"].objects.update(gen_description=True)


    def backwards(self, orm):

        # Deleting field 'ForumPost.gen_description'
        db.delete_column('forum_forumpost', 'gen_description')
