...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumPost.rating_average'
        db.add_column('forum_forumpost', 'rating_average', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'ForumPost.rating_count'
        db.add_column('forum_forumpost', 'rating_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ForumPost.rating_average'
        db.delete_column('forum_forumpost', 'rating_average')

        # Deleting field 'ForumPost.rating_count'
        db.delete_column('forum_forumpost', 'rating_count')
    ...
    models = {
        ...
        'forum.forumpost': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'forumposts'", 'blank': 'True', 'to': "orm['forum.ForumCategory']"}),
