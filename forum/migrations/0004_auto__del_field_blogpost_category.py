...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ForumPost.category'
        db.delete_column('forum_forumpost', 'category_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'ForumPost.category'
        db.add_column('forum_forumpost', 'category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='forumposts', null=True, to=orm['forum.ForumCategory'], blank=True), keep_default=False)
