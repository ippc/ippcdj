...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumPost.rating_sum'
        db.add_column('forum_forumpost', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForumPost.rating_sum'
        db.delete_column('forum_forumpost', 'rating_sum')
