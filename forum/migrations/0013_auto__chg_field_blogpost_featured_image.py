...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForumPost.featured_image'
        db.alter_column('forum_forumpost', 'featured_image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'ForumPost.featured_image'
        db.alter_column('forum_forumpost', 'featured_image', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))
