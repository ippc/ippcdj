...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumPost.comments_count'
        db.add_column('forum_forumpost', 'comments_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'ForumPost.description'
        db.alter_column('forum_forumpost', 'description', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table('forum_comment', (
            ...
            ('replied_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', null=True, to=orm['forum.Comment'], blank=True)),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('blog', ['Comment'])

        # Deleting field 'ForumPost.comments_count'
        db.delete_column('forum_forumpost', 'comments_count')

        # Changing field 'ForumPost.description'
        db.alter_column('forum_forumpost', 'description', self.gf('mezzanine.core.fields.HtmlField')(blank=True))
