...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumCategory.site'
        db.add_column('forum_forumcategory', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=site.pk, to=orm['sites.Site']), keep_default=False)

        # Adding field 'ForumPost.allow_comments'
        db.add_column('forum_forumpost', 'allow_comments', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForumCategory.site'
        db.delete_column('forum_forumcategory', 'site_id')

        # Deleting field 'ForumPost.allow_comments'
        db.delete_column('forum_forumpost', 'allow_comments')
