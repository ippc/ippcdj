...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ForumPost_Files'
        m2m_table_name = db.shorten_name(u'forum_forumpost_notification_groups')
    ...
    def backwards(self, orm):
        # Deleting model 'ForumPost_Files'
        db.delete_table(u'forum_forumpost_files')

        # Removing M2M table for field notification_groups on 'ForumPost'
        db.delete_table(db.shorten_name(u'forum_forumpost_notification_groups'))
    ...
    models = {
        ...
        u'forum.forumpost': {
            ...
            'notification_groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'forumnotificationgroups'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.Group']"}),
        ...
        u'forum.forumpost_files': {
            'Meta': {'object_name': 'ForumPost_Files'},
