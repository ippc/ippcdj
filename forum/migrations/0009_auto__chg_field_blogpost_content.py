...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForumPost.content'
        db.alter_column('forum_forumpost', 'content', self.gf('mezzanine.core.fields.RichTextField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'ForumPost.content'
        db.alter_column('forum_forumpost', 'content', self.gf('mezzanine.core.fields.HtmlField')())
