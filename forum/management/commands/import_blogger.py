...
from forum.management.base import BaseImporterCommand


class Command(BaseImporterCommand):
    """
    Implements a Forumger importer. Takes a Forumger ID in order to be able to
    determine which forum it should point to and harvest the XML from.
    """

    option_list = BaseImporterCommand.option_list + (
        make_option("-b", "--forumger-id", dest="forum_id",
            help="Forumger Forum ID from forumger dashboard"),
    )
