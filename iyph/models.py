...
class IYPHSteeringCommitteeResource (Displayable, models.Model):
    ...
    link_es = models.URLField(blank=True, null=True,)
    link_fr = models.URLField(blank=True, null=True,)
    link_ar = models.URLField(blank=True, null=True,)
    link_zh = models.URLField(blank=True, null=True,)
    link_ru = models.URLField(blank=True, null=True,)
