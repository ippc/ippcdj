...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IyphPost'
        db.create_table(u'iyph_iyphpost', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='iyphposts', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'iyph', ['IyphPost'])

        # Adding M2M table for field categories on 'IyphPost'
        m2m_table_name = db.shorten_name(u'iyph_iyphpost_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('iyphpost', models.ForeignKey(orm[u'iyph.iyphpost'], null=False)),
            ('iyphcategory', models.ForeignKey(orm[u'iyph.iyphcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['iyphpost_id', 'iyphcategory_id'])

        # Adding M2M table for field related_posts on 'iyphPost'
        m2m_table_name = db.shorten_name(u'iyph_iyphpost_related_posts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_iyphpost', models.ForeignKey(orm[u'iyph.iyphpost'], null=False)),
            ('to_iyphpost', models.ForeignKey(orm[u'iyph.iyphpost'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_iyphpost_id', 'to_iyphpost_id'])

        # Adding model 'iyphCategory'
        db.create_table(u'iyph_iyphcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'iyph', ['IyphCategory'])


    def backwards(self, orm):
        # Deleting model 'iyphPost'
        db.delete_table(u'iyph_iyphpost')

        # Removing M2M table for field categories on 'iyphPost'
        db.delete_table(db.shorten_name(u'iyph_iyphpost_categories'))

        # Removing M2M table for field related_posts on 'iyphPost'
        db.delete_table(db.shorten_name(u'iyph_iyphpost_related_posts'))

        # Deleting model 'iyphCategory'
        db.delete_table(u'iyph_iyphcategory')
    ...
    models = {
        ...
        u'iyph.iyphcategory': {
            'Meta': {'ordering': "('title',)", 'object_name': 'IyphCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'iyph.iyphpost': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'IyphPost'},
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'allow_comments': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'iyphposts'", 'blank': 'True', 'to': u"orm['iyph.IyphCategory']"}),
            ...
            'related_posts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_posts_rel_+'", 'blank': 'True', 'to': u"orm['iyph.IyphPost']"}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'iyphposts'", 'to': u"orm['auth.User']"})
        },
        u'comments.comment': {
