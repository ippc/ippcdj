...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransChronology'
        db.create_table(u'iyph_transchronology', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('translation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translation', to=orm['iyph.Chronology'])),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'iyph', ['TransChronology'])


    def backwards(self, orm):
        # Deleting model 'TransChronology'
        db.delete_table(u'iyph_transchronology')
